...
/* ========================================================================
* Table of CRC-32's of all single-byte values (precomputed)
*/
...
/* ========================================================================= */
unsigned long P3DUpdateCRC32( unsigned long crc,
...
{
	unsigned long c = P3DUpdateCRC32( 0x00000000L, NULL, 0 );
	c = P3DUpdateCRC32(c, buf, len);
