...
//
// Author:	KEXIK
// Purpose:	Corkscrew phys. constraint - entity class
//-----------------------------------------------------------------------------
#include "ePhys_corkscrew.h"

REGISTER_ENTITY(ePhys_corkscrew, "phys_corkscrew", false, true, false);

ePhys_corkscrew::ePhys_corkscrew()
{
...
bool ePhys_corkscrew::Spawn(geometryData_s& gdata)
{
...
void ePhys_corkscrew::Think(float deltaTime)
{
...
void ePhys_corkscrew::Break(eBase* pCaller, int nValue)
{
