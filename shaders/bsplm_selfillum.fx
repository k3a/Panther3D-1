...
float4 ps_main (VS_OUTPUT IN) : COLOR0
{
	...
	color.xyz *= saturate (tex2D (LMTexture, IN.uv1).xyz + color.w);
	return color;
}
...
technique bsplm_selfillum_lighted
{
	pass Pass0
	{
		VertexShader = compile vs_1_1 vs_main();
...
////////////////////////////////////////////////////////////////////////
technique bsplm_selfillum_sm30
{
   pass Pass0
   {
      VertexShader = compile vs_1_1 vs_main();
...
technique bsplm_selfillum_sm30_lighted
{
	pass Pass0
	{
		VertexShader = compile vs_1_1 vs_main();
