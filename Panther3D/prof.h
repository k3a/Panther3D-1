...
/*
 *  Prof_draw_dx -- display the current report via DirectX Renderer
 *
 ...
 */
extern void Prof_draw_dx(float sx, float sy,
 ...
 */
extern void Prof_draw_graph_dx(float sx, float sy,
